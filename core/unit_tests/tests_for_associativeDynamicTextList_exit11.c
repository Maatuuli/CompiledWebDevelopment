...
executeTest1(void)
{
    char* titleFromTest = "#11 Add new element with not unique key which is not allowed!";
    printf("[SUCCESS] %s\n", titleFromTest);
    ...
    addElementByKeyInListForAssociativeDynamicText(&list1, "name1", "value2", __FILE__, __LINE__);
}
