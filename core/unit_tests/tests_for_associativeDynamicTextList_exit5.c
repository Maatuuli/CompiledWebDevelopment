...
executeTest1(void)
{
    char* titleFromTest = "#05 Add element on empty parameter for list is not allowed!";
    printf("[SUCCESS] %s\n", titleFromTest);
    
    addElementByKeyInListForAssociativeDynamicText(NULL, "name1", "value1", __FILE__, __LINE__);
}
