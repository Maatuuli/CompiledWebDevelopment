...
executeTest1(void)
{
    char* titleFromTest = "#02 Check if key exists on NULL parameter for list is not allowed!";
    printf("[SUCCESS] %s\n", titleFromTest);
    
    checkIfKeyExistsInListForAssociativeDynamicText(NULL, "name1", __FILE__, __LINE__);
}
