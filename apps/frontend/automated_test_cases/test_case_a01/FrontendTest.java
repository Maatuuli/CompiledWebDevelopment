 ...
 * ?> javac -d ./test_case_a01/classes --class-path "./selenium-server-4.10.0.jar" ./Helper.java ./test_case_a01/FrontendTest.java; cd ./test_case_a01/classes; jar --create --file=../../test_case_a01.jar  --manifest=../../manifest.mf ./*.class; cd -
 * 
 * Execute with:
